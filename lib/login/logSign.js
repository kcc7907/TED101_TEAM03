        ...
        switch(theCheck){
            ...
            case 1:
                ...
                if(accNum < 6 || accNum > 12 ){
                    let str = '帳號請輸入 6 - 12 字元。'; // -- new
                    confirmLogSign(str); // -- new
                }else if(pwdNum < 6 || pwdNum > 12){
                    let str = '密碼請輸入 6 - 12 字元。'; // -- new
                    confirmLogSign(str); // -- new
                }else if((accNum < 6 && accNum > 12) || (pwdNum < 8 && pwdNum > 12)){
                    let str = '帳號及密碼請輸入 6 - 12 字元。'; // -- new
                    confirmLogSign(str); // -- new
                }else{
